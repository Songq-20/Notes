...
trimmomatic PE -threads 4  $R1 $R2 $R1_T $R1_T_U $R2_T $R2_T_U ILLUMINACLIP:/data01nfs/user/liupf/common_files/TruSeq3-PE.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36
```
